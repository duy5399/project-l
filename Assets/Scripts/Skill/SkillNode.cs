...
public class SkillNode : MonoBehaviour
{
    ...
    public void OnClick_DisplayInfo()
    {
        ...
        SkillsManager.instance.skillInfo.skillName.text = skillBase.skill_name +" Lv." + tempLv;
        SkillsManager.instance.skillInfo.skillType.text = skillBase.skill_use_type == "Passive" ? "K/N Bị Động" : "K/N Chủ Động";
        //SkillsManager.instance.skillInfo.description.text = skillBase.skill_info[curLv].Description();
        ...
        skillLv.text = tempLv + "/" + skillBase.max_level;
    }
    ...
    {
        if(tempLv >= skillBase.max_level || SkillsManager.instance.tempPoint <= 0)
        {
            return;
        }
        SkillsManager.instance.tempPoint -= 1;
