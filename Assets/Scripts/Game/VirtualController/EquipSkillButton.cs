...
public class EquipSkillButton : MonoBehaviour
{
    [SerializeField] protected SkillBase _skillBase;
    ...
    protected virtual void Update()
    {
        ...
        cooldownImg.fillAmount = curCooldown / this.skillBase.skill_info[skillLv].cd;
    ...
    protected virtual void OnClick_TriggerSkill()
    {
        ...
        if (!chBase.chSkill.target)
        {
            SocketIO.instance.skillSocketIO.Emit_TriggerSkill(this.skillBase.skill_id);
        }
    }
}
